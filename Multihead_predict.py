...
#python3 Multihead_predict.py --onlypredict --dataset "../direct_8_fold_data/Testseq7.fasta" --outputpath ../direct_8_fold_data/
#change name for every folds! for evaluate_mcc! the last column not used! 

#python3 Multihead_predict.py --onlypredict --dataset ~/mRNA_localization/cell_paper_APEX-Seq/extracted_ensembl_mRNA.fasta --outputpath '/home/deep/mRNA_localization/cell_paper_APEX-Seq/ensembl_mRNA/add_cytosol_to_original/'

#python3 Multihead_predict.py --onlypredict --dataset "/home/deep/mRNA_localization/pans_paper_data/ncbiseq_refseq_mRNA.fasta" --outputpath "/home/deep/mRNA_localization/pans_paper_data/ncbiseq_refseq_mRNA/add_cytosol_to_original/"

#python3 Multihead_predict.py --onlypredict --onlypredict --dataset /home/deep/mRNA_localization/human_mRNA_refseq/GRCh38_latest_mrna.fna --outputpath ./Results/human_mRNA_refseq/

#test remove cytoplasm
#python3 Multihead_predict.py --onlypredict --dataset "../direct_8_fold_data/Testseq7.fasta" --outputpath ../direct_8_fold_data/testremovecytoplasm

#test attention weight
#python3 Multihead_predict.py --dataset '../../../../For_paper/biology analyese/HUMAN_beta_actin_NC_000007.14_modified.fasta' --outputpath ./Results/testhuman_att/ --weights_dir "Results/direct_8fold_model/weights_fold_"
